...
import { MarketCreationArguments, MarketCreationResult } from "./models.js"
...
// manager.getMarketById2(568).then(console.log).catch(console.error).finally(() => process.exit());

const marketCreationArguments = new MarketCreationArguments();
marketCreationArguments.question = "Will Iron man destroy Batman?"
marketCreationArguments.description = "The fight will be epic"
marketCreationArguments.slug = "iron-man-destroys-batman"
marketCreationArguments.durationHours = 24 * 4
manager.createMarket(marketCreationArguments).then(console.log).catch(console.error).finally(() => process.exit());
